...
const CLessonDetails = ({ lesson }: { lesson: CLesson }) => {
          ...
          <div className="card bg-white shadow-xl border border-blue-100 overflow-hidden">
            {videoId && !videoError ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-gray-400 bg-gray-50">
                <FaExclamationTriangle size={48} className="mb-4 text-blue-400" />
                ...
                {lesson.videoUrl && (
                  <a
                    ...
                    className="btn btn-sm bg-blue-500 hover:bg-blue-600 border-none text-white mt-4"
                  >
                    <FaYoutube />
                    Open in YouTube
                  </a>
          ...
          <div className="card bg-white shadow-xl border border-blue-100">
            <div className="card-body">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-outline border-blue-300 hover:bg-blue-100 mt-2 gap-2"
              >
                <FaGlobe />
                Open Programiz
              </a>
